	...
	<div id="top-header">
		...
		<div class="container">
			...
			<ul class="header-links pull-left">
				...
				<li class="header-contact-phone"><a href="tel:+963959498994" class="contact-link"><i class="fa fa-phone" aria-hidden="true"></i><span class="contact-link__text" dir="ltr">+963 959 498 994</span></a></li>

				<li class="header-contact-email"><a href="mailto:electro@gmail.com" class="contact-link contact-link--email"><i class="fa fa-envelope-o" aria-hidden="true"></i><span class="contact-link__text" dir="ltr">electro@gmail.com</span></a></li>

				<li class="header-contact-location"><a href="#" class="contact-link"><i class="fa fa-map-marker" aria-hidden="true"></i><span class="contact-link__text" dir="ltr">Damascus, Syria, AL-Mazzah</span></a></li>
