...
(function () {
	...
	var strings = {
		ar: {
			...
			phoneHint: '10 أرقام، مثال: 09XXXXXXXX',
			...
			phoneDigitsError: 'يجب أن يكون رقم الهاتف 10 أرقام (مثال: 09XXXXXXXX)',
			phoneUpdateFailed: 'تعذّر تحديث رقم الهاتف',
			...
			forgotPasswordHint: 'أدخل بريدك الإلكتروني وسنرسل لك رابطاً لإعادة تعيين كلمة المرور.',
			sendResetLink: 'إرسال رابط الاستعادة',
			backToSignIn: 'العودة لتسجيل الدخول',
			noAccountSignUp: 'ليس لديك حساب؟ إنشاء حساب',
			hasAccountSignIn: 'لديك حساب بالفعل؟ تسجيل الدخول',
			...
			loginNoToken: 'فشل تسجيل الدخول. لم يتم استلام رمز الدخول. حاول مرة أخرى.',
			signInFailed: 'فشل تسجيل الدخول. حاول مرة أخرى.',
			emailVerifiedSignIn: 'تم تفعيل البريد بنجاح. يمكنك تسجيل الدخول الآن.',
			googleSignInFailed: 'فشل تسجيل الدخول عبر Google. حاول مرة أخرى.',
			enterEmailThenResend: 'أدخل بريدك أعلاه ثم اضغط إعادة الإرسال.',
			resendVerificationFailed: 'تعذّر إعادة إرسال رسالة التفعيل',
			enterName: 'يرجى إدخال الاسم',
			enterPasswordSignup: 'يرجى إدخال كلمة المرور',
			passwordMin6: 'يجب أن تكون كلمة المرور 6 أحرف على الأقل',
			passwordConfirmMismatch: 'كلمة المرور والتأكيد غير متطابقين',
			registrationSuccess: 'تم التسجيل بنجاح! أرسلنا رسالة تفعيل إلى بريدك.',
			registrationFailed: 'فشل التسجيل. تحقق من البيانات وحاول مرة أخرى.',
			...
			resetSuccess: 'تم إعادة تعيين كلمة المرور. يمكنك تسجيل الدخول الآن.',
		...
		en: {
			...
			phoneHint: '10 digits, e.g. 09XXXXXXXX',
			phonePlaceholder: '09XXXXXXXX',
			...
			phoneDigitsError: 'Phone number must be exactly 10 digits (e.g. 09XXXXXXXX)',
			...
			loginNoToken: 'Login failed. No token received. Please try again.',
			signInFailed: 'Sign in failed. Please try again.',
			emailVerifiedSignIn: 'Email verified successfully. You can sign in now.',
			googleSignInFailed: 'Google sign-in failed. Please try again.',
			enterEmailThenResend: 'Enter your email above, then click resend.',
			resendVerificationFailed: 'Failed to resend verification email.',
			enterName: 'Please enter your name.',
			enterPasswordSignup: 'Please enter a password.',
			passwordMin6: 'Password must be at least 6 characters.',
			passwordConfirmMismatch: 'Password and confirmation do not match.',
			registrationSuccess: 'Registration successful! A verification email has been sent to your inbox.',
